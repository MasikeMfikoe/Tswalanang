  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      ...
      <p className="text-lg text-muted-foreground">
        This is a test dashboard to verify component rendering and data visualization.
      </p>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">This section would display a table of recent orders.</p>
        </CardContent>
      </Card>
    </div>
  )
