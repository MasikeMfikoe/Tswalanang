...
export default function CustomerRateCardPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <PageHeader
        title={`Rate Card for Customer ${customerId}`}
        description="Manage specific shipping rates for this customer."
      />
      <RateCard
        ...
        setFreightTypes={setFreightTypes}
        editingId={editingId}
        setEditingId={setEditingId}
        newRate={newRate}
        setNewRate={setNewRate}
        newFreightType={newFreightType}
        setNewFreightType={setNewFreightType}
        handleSave={handleSave}
        handleAddRate={handleAddRate}
        handleAddFreightType={handleAddFreightType}
      />
    </div>
  )
}
