...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<React.HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<React.HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
